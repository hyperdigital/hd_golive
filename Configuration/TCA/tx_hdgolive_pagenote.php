...
return [
    ...
    'columns' => [
        ...
        'pagecheck' => [
            'exclude' => true,
            'label' => 'LLL:EXT:hd_golive/Resources/Private/Language/locallang_db.xlf:tx_hdgolive_pagecheck',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_hdgolive_pagecheck',
                'minitems' => 1,
                'maxitems' => 1,
            ],
        ],
    ...
    'types' => [
        '0' => [
            'showitem' => 'hidden, pagecheck, note_status, note_text',
        ],
    ],
];
